(function() {
    ...
    angular
        .module('modals')
        .controller('resourceEditInstanceController', resourceEditInstanceController);

    resourceEditInstanceController.$inject = ['dataService', '$uibModalInstance', 'resource', 'utilityService'];

    /* @ngInject */
    function resourceEditInstanceController(dataService, $uibModalInstance, resource, Util) {
        var vm = this;
