(function() {
    ...
    angular
        .module('modals')
        .controller('departmentEditInstanceController', departmentEditInstanceController);

    departmentEditInstanceController.$inject = ['dataService', '$uibModalInstance', 'department', 'utilityService'];

    /* @ngInject */
    function departmentEditInstanceController(dataService, $uibModalInstance, department, Util) {
        var vm = this;
